          ...
          history.map((item) => (
            ...
            >
              ...
              <div className="flex items-center ml-2">
                <button className="p-1 rounded-md text-gray-500 dark:text-gray-400 hover:text-yellow-600 dark:hover:text-yellow-400">
                  <EditIcon className="w-4 h-4" />
                </button>
                <button className="p-1 rounded-md text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400">                    <TrashIcon className="w-4 h-4" />
                </button>
              </div>
            </div>
          ))
